test_that("Test for x.side argument", {
    ...
    expect_no_error(post_plot(x.color = "blue"))
    
    
    # Test for y.color argument
    expect_no_error(post_plot(y.color = "red"))
    
    
    # Test for main argument
    expect_no_error(post_plot(main = "Title"))
    ...
    expect_no_error(post_plot(x.color = "blue", y.color = "red"))
    
    
    # Test for main and x.color arguments combination"
    expect_no_error(post_plot(main = "Title", x.color = "blue"))
})