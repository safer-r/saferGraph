test_that("the function width works correctly", {
    ...
    expect_no_error(width(categ.nb = 10.5, inch.left.space = 1, inch.right.space = 1))
    ...
    expect_no_error(width(categ.nb = 0, inch.left.space = 1, inch.right.space = 1, inches.per.categ.nb = 0.2, ini.window.width = 7, boundarie.space = 0.5))
})
