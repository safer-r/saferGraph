test_that("the function width works correctly", {
    ...
    # Test with zero
    expect_error(width(categ.nb = 0, inch.left.space = 1, inch.right.space = 1))
    ...
    # Test with zero
    expect_error(width(categ.nb = 10, inch.left.space = 1, inch.right.space = 1, ini.window.width = 0))
    ...
    # Test with zero
    expect_error(width(categ.nb = 10, inch.left.space = 0, inch.right.space = 1))
    ...
    # Test with zero
    expect_error(width(categ.nb = 10, inch.left.space = 1, inch.right.space = 0))
    ...
    expect_no_error(width(categ.nb = 10, inch.left.space = 1, inch.right.space = 1, inches.per.categ.nb = 0.2, ini.window.width = 7, boundarie.space = 0.5))
    
    # Test with invalid arguments
    expect_error(width(categ.nb = 0, inch.left.space = 1, inch.right.space = 1, inches.per.categ.nb = 0.2, ini.window.width = 7, boundarie.space = 0.5))
})
