test_that("empty_graph function argument tests", {
  ...
  expect_no_error(empty_graph(text = "No Graph", text.size = 1, title = "Graph Title", title.size = 1.5))
  
  # Test with invalid arguments
  # expect_error(empty_graph(text = NULL, text.size = 1, title = "Graph Title", title.size = 1.5))
  expect_error(empty_graph(text = "No Graph", text.size = NULL, title = "Graph Title", title.size = 1.5))
  # expect_error(empty_graph(text = "No Graph", text.size = 1, title = NULL, title.size = 1.5))
  expect_error(empty_graph(text = "No Graph", text.size = 1, title = "Graph Title", title.size = NULL))
  expect_error(empty_graph(text = "No Graph", text.size = "invalid_size", title = "Graph Title", title.size = 1.5))
  expect_error(empty_graph(text = "No Graph", text.size = 1, title = "Graph Title", title.size = "invalid_size"))
