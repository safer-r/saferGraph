...
remotes::install_github("https://github.com/safer-r/saferGraph") # or open R as admin and remotes::install_github("https://github.com/safer-r/saferGraph", lib = "C:/Program Files/R/R-4.6.0/library")
```
