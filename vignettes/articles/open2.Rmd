...
open2(pdf = FALSE, pdf.name = "safer2")
```
<br>
...
open2(pdf = FALSE, pdf.path = ".", pdf.name = "graph1", width = 7, height = 7, paper = "special", pdf.overwrite = FALSE, rescale = "fixed", remove.read.only = TRUE, return.output = FALSE)
```
<br>